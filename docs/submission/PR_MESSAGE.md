...
| 至少 2 个端到端 demo 流程，附 ≤2 min 视频或 GIF | 3 条流程：① 好样本 PASS ② 公式错误被规则层 0.5 秒拦截 ③ 伪启发包装被维度 9 判低分；演示视频见独立仓库 [`docs/demo.mp4`](https://github.com/tzz-12/edu-eval-hy3/blob/main/docs/demo.mp4)（110 秒） |
